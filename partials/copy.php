...
<span class="info">&copy; <?php echo date("Y") . " " .$siteName; ?> by <a href="https://github.com/kakauandme/beats1.media#beats1media" title="View on Github" target="_blank">@kakauandme</a></span>
</p>